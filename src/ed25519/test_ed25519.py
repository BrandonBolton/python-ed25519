...
class Basic(unittest.TestCase):
    ...
    def test_keypair(self):
        ...
        self.assertTrue(hexlify(sk.to_bytes()), hexlify(sk2.to_bytes()))

        # Ensure we use a more dynamic entropy source
        sk1, vk1 = ed25519.create_keypair()
        sk2, vk2 = ed25519.create_keypair()

        # Expect different results here as the keypairs should naturally differ
        self.assertNotEqual(sk1.to_ascii(encoding="base64"),
                            sk2.to_ascii(encoding="base64"))
        self.assertNotEqual(vk1.to_ascii(encoding="base64"),
    ...
    def test_publickey(self):
        ...
        # Generate a different seed for sk2
        seed2 = os.urandom(32)  # Random 32-byte seed
        sk2 = ed25519.SigningKey(seed2)
        self.assertNotEqual(sk, sk2)  # sk and sk2 should not be equal # If the sk and sk2 should not be equal
